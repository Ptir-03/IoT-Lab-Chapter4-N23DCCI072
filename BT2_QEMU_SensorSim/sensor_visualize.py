import matplotlib
matplotlib.use('Agg')  # Bắt buộc cho QEMU headless để không bị lỗi hiển thị
...
pot = SimPotentiometer(initial_value=0.3) # span = 30cm
...
# Vẽ đường dữ liệu khoảng cách (màu xanh)
...
# Tô màu vùng phía dưới đường span
